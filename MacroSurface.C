...
void MacroSurface() {
  ...
  TCanvas *c1 = new TCanvas("c1","Surface",1000,10,1400,1000);
   ...
   Double_t Test[I] = {0, 1, 2, 3};
   Double_t S1[I] = {93.01, 115.9, 818., 75.59};
   Double_t S2[I] = {63.97, 35.26, 29.12, 65.11};
   Double_t S3[I] = {33.37, 43.66, 65.45, 110.3};
   Double_t S4[I] = {130.5, 482.6, 313.8, 83.18};
   Double_t S5[I] = {134.1, 200.8, 171.6, 482.7};
   Double_t S6[I] = {209.3, 142.5, 344.3, 132.7};
   Double_t S7[I] = {48.76, 46.26, 69., 37.29};
   ...
   std::cout << "---------------------------" << std::endl;
   std::cout << "---------------------------" << std::endl;
   std::cout << "---- ANOVA MR1F Surface ---" << std::endl;
   std::cout << "---------------------------" << std::endl;
   std::cout << "---------------------------" << std::endl;
   ...
   // Précision : Ici, les valeurs sont minimisées car le tableau donne une valeur pour F(3,18) et F(6,18) mais pas v2 = 18. Extrapolation nécessaire ?
