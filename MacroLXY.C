...
void MacroLXY() {
  ...
  TCanvas *c1 = new TCanvas("c1","LXY",1000,10,1400,1000);
   ...
   Double_t S1[n] = {285.1, 462.2, 958., 298.3};
   Double_t S2[n] = {230.8, 274, 249.3, 313.};
   Double_t S3[n] = {296.1, 282.8, 424.2, 384.8};
   Double_t S4[n] = {493.5, 676.2, 559.1, 458.6};
   Double_t S5[n] = {385.3, 372.2, 575.3, 611.8};
   Double_t S6[n] = {349.4, 398.3, 689, 506};
   Double_t S7[n] = {317.6, 336.3, 516.4, 348};
   ...
   std::cout << "---------------------------" << std::endl;
   std::cout << "---------------------------" << std::endl;
   std::cout << "------ ANOVA MR1F LXY -----" << std::endl;
   std::cout << "---------------------------" << std::endl;
   std::cout << "---------------------------" << std::endl;
   ...
   grS1->SetTitle("LXY (mm)");
   grS1->GetXaxis()->SetTitle("Test");
   grS1->GetYaxis()->SetRangeUser(200,1000);
